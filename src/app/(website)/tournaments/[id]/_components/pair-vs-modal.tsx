...
const PairVsModal = ({ isModalOpen, handleCloseModal, matchInfo }: Props) => {
  return (
    <Dialog open={isModalOpen} onOpenChange={handleCloseModal}>
      <DialogContent className="bg-white lg:max-w-5xl max-w-[95vw] sm:max-w-lg md:max-w-xl">
            ...
            <div className="flex items-center gap-5">
              <div>
                ...
                <p className="text-sm md:text-base text-gray-600 mt-1">
                  Handicap:{" "}
                  {matchInfo?.pair1Id?.player1?.handicap || "Not Updated"}
                </p>

                <p className="text-sm md:text-base text-gray-600 mt-1">
                  Club Name:{" "}
                  {matchInfo?.pair1Id?.player1?.clubName || "Not Updated"}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm md:text-base text-gray-600 mt-1">
                  Handicap:{" "}
                  {matchInfo?.pair1Id?.player2?.handicap || "Not Updated"}
                </p>

                <p className="text-sm md:text-base text-gray-600 mt-1">
                  Club Name:{" "}
                  {matchInfo?.pair1Id?.player2?.clubName || "Not Updated"}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center text-center w-full md:w-1/2">
            ...
            <div className="flex items-center gap-5">
              <div>
                ...
                <p className="text-sm md:text-base text-gray-600 mt-1">
                  Handicap:{" "}
                  {matchInfo?.pair2Id?.player1?.handicap || "Not Updated"}
                </p>

                <p className="text-sm md:text-base text-gray-600 mt-1">
                  Club Name:{" "}
                  {matchInfo?.pair2Id?.player1?.clubName || "Not Updated"}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm md:text-base text-gray-600 mt-1">
                  Handicap: {matchInfo?.pair2Id?.player2?.handicap || "Not Updated"}
                </p>

                <p className="text-sm md:text-base text-gray-600 mt-1">
                  Club Name: {matchInfo?.pair2Id?.player2?.clubName || "Not Updated"}
                </p>
              </div>
            </div>
          </div>
