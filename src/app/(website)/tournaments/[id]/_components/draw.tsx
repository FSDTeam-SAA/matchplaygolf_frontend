  ...
  return (
    <div className="space-y-6">
      {matches.map((item, index) => {
        const winner1 = item?.winnerPlayerId === item?.player1Id?._id;
        const winner2 = item?.winnerPlayerId === item?.player2Id?._id;

        return (
          <div key={item._id} className="flex items-center gap-5 space-y-5">
              ...
              <div className="border-b border-b-gray-300 flex items-center">
                <div
                  className={`border-r border-gray-300 lg:w-1/2 p-6 ${
                    winner1 ? `bg-[${item?.winnerColor}] text-white` : ""
                  }`}
                >
                ...
                <div
                  className={`border-l border-gray-300 lg:w-1/2 flex justify-end p-6 ${
                    winner2 && `bg-[${item?.winnerColor}] text-white`
                  }`}
                >
                  <div className="flex items-center gap-3">
