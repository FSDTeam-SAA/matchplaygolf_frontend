...
const formSchema = z.object({
  ...
  organizerLogo: z.instanceof(File).optional(), // Single File, not array
                        ...
                        >
                          <div className="flex flex-col items-center justify-center h-full space-y-3">
                            ...
                            <p className="text-base text-[#707070]">
                              Drag and drop image here, <br /> or click to add image
                            </p>
                          </div>
                          <input
                            id="image-upload"
...
//                             width={292}
//                             height={277}
//                             src={previewImage || "/images/PreviewUnavailable.jpg"}
//                             alt="Preview"
